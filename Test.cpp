...
void testSetElementInvalid2() {
 ...
 int setinvalid_row = 10, setinvalid_col = 10;
 int row=3,col=4;
     int data[3][4] = {{1,2,3,4},{5,6,7,8},{0,0,1,2}};
 int*input_data[3];
   for (int i=0;i<3;i++){
    input_data[i]=data[i];
   }
...
int row=3,col=4;
   int data[3][4] = {{1,2,3,4},{5,6,7,8},{0,0,9,0}};
int*input_data[3];
for (int i=0;i<3;i++){
    input_data[i]=data[i];
}
...
void testAddToValid2() {
  int add_to_data[3][3] = {{3,4,5}, {1,2,3}, {0,0,0}}; // add to 'data' matrix, dimension not match
  int add_to_above[4][3] = {{1,0,-1}, {2,1,0}, {2,2,2}}; // add to 'add_to_data' matrix
  int row=3;int col=3;
...
void testSubMatrixInvalid2() {
 ...
 int row=4,col=3;
     int data[4][3] = {{1,2,3},{6,7,8},{0,0,1},{0,0,0}};
 int*input_data[4];
 for (int i=0;i<4;i++){
    input_data[i]=data[i];
 }
...
void testIsUpperTrFalseSquare2() {

int row=5,col=5;
   int upper1[5][5] = {{1,5,1,5},{0,7,6,5},{0,1,4,9},{0,0,0,0}};
 int*input_upper1[5];
 for (int i=0;i<5;i++){
    input_upper1[i]=upper1[i];
 }
